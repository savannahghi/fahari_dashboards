      ...
      <section className="bg-slate-100 w-screen p-5 flex flex-col space-y-6">
        ...
        <section className="flex flex-col justify-center items-center">
          <iframe
            ...
            src="https://app.powerbi.com/view?r=eyJrIjoiZGUyZjJlMzctMzhlYS00MzAyLTk1MTAtN2RjZTkzYmQ0Y2MwIiwidCI6IjYyNjg2NDAwLTllZjMtNDBkOS04ZTQxLWRiMTUzNzRiZTViZSJ9&pageName=ReportSection"
            frameBorder="0"
          ></iframe>
        </section>
      </section>
