  ...
  return (
    <section className="grid grid-cols-2 h-screen">
      <section className=" bg-blue-500 flex flex-col justify-center items-center">
        ...
        <h1 className="text-center font-semibold text-2xl relative right-11 antialiased tracking-wide text-white">
          Fahari ya Jamii Dashboards
        </h1>
      </section>
      <section className="p-10">
        ...
        <form className=" flex flex-col space-y-6 mt-14">
          ...
          <input
            ...
            className="border-2 border-solid border-black p-3 w-4/5 rounded-md"
          />
          ...
          <input
            ...
            value="Login"
            className="bg-blue-600 text-white block w-60 h-10 rounded-md font-semibold cursor-pointer"
          />
